...
*/
/* Routines which expose STM32F411 Blackpill specific functionality to the mri debugger. */
#include <string.h>
#include <core/platforms.h>
#include <core/try_catch.h>
#include <architectures/armv7-m/debug_cm3.h>
#include <devices/stm32f411xx/stm32f411xx_init.h>


void Platform_Init(Token* pParameterTokens)
{
    mriStm32f411xx_Init(pParameterTokens);
}
